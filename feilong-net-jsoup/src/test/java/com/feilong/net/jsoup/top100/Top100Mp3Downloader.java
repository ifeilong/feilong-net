...
public class Top100Mp3Downloader{
    ...
    /** The Constant LOGGER. */
    private static final Logger LOGGER = LoggerFactory.getLogger(Top100Mp3Downloader.class);
    ...
    public static void main(String[] args){
        ...
        Map<String, String> map = Top100Mp3Downloader.findIds("http://www.top100.cn/artist/info-agr5dcqe.shtml");
        for (Map.Entry<String, String> e : map.entrySet()){
            String name = e.getKey();
            String path = m.findDownPathById(e.getValue());
            m.downByPath("F:\\music\\files\\Michael Jackson", name, path);
            LOGGER.info(name + " from " + path + " has down!");
        }
    }
    ...
    private String findDownPathById(String id){
        ...
        try{
            URL url = URLUtil.toURL("http://www.top100.cn/download/download.aspx?Productid=" + id);
    ...
    private void downByPath(String dir,String name,String path){
        ...
        try{
            ...
            if (httpURLConnection.getResponseCode() == HttpURLConnection.HTTP_OK){
                ...
                LOGGER.info("服务器返回:" + httpURLConnection.getResponseCode());
            }
        }catch (MalformedURLException e){
            LOGGER.error(e.getClass().getName(), e);
        }catch (IOException e){
